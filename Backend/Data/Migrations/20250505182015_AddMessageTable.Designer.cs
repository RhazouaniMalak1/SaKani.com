...
namespace Projet1.Data.Migrations
{
    ...
    [Migration("20250505182015_AddMessageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projet1.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RecipientId", "SenderId", "Timestamp");
            ...
            modelBuilder.Entity("Projet1.Models.Message", b =>
                {
                    b.HasOne("Projet1.Models.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Projet1.Models.User", "Sender")
                        .WithMany()
