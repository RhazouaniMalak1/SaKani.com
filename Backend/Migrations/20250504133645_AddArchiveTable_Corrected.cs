        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Annonces_AspNetUsers_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnonceClients", x => new { x.ClientId, x.AnnonceId });
                    table.ForeignKey(
                        name: "FK_AnnonceClients_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnonceClients_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnonceClients_AnnonceId",
                table: "AnnonceClients",
                column: "AnnonceId");

            migrationBuilder.CreateIndex(
                name: "IX_Annonces_AdminId",
                table: "Annonces",
                column: "AdminId");
